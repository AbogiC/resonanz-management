<template>
    <div class="bg-base-100 p-6 rounded-xl shadow-md dark:bg-white/5 dark:backdrop-blur-md 
         dark:[--webkit-backdrop-filter:blur(10px)] dark:border-white/20 mb-6">
         <h2 class="text-lg font-semibold mb-4">Product Performance by Region</h2>
...
ChartJS.register(
    Title,Tooltip,Legend,CategoryScale,BarElement,
    LinearScale
)
